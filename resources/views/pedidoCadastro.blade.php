                ...
                <div class="form-group row">
                    <div class="col-md-6 offset-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="check_exclusivo" id="check_exclusivo" {{ old('check_exclusivo') ? 'checked' : '' }}>

                            <label class="form-check-label" for="check_exclusivo">
